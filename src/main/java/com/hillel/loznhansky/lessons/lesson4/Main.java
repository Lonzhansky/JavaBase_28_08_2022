package com.hillel.loznhansky.lessons.lesson4;
...
//        System.out.println(Math.abs(2323));
//        System.out.println(Math.abs(-2323));


        // range from 0.0 to 0.999999999999
        // 0.0 * 21 = 0.0 -> int 0
        // 0.9999999 * 21 = 20.9999999999 -> int 20
...
//        int max = 40;
//
//        System.out.println((int) (Math.random() * 26) + 15);
